...
> - **Rappel d'échéance du jour étendu au Transport** *(21/09/2026, PR #468)* : le popup de rappel affiché à la connexion (jusque-là Repas/Affaires/Administratif/Autre, voir Changelog v1.34 → v1.35, PR #435) couvre désormais aussi la catégorie Transport — affiché pour la personne ayant pris en charge un trajet aller et/ou retour dont la date confirmée tombe le jour même — voir §3.8
> - **Détails contextuels du rappel Transport + rôle « auteur »** *(21/09/2026, PR #469)* : le popup de rappel Transport précise désormais le bénéficiaire du trajet et l'heure aller/retour effectivement prise en charge ; l'auteur du besoin (ou son bénéficiaire nommé via « Pour une autre personne »), qui ne conduit pas lui-même, reçoit lui aussi ce rappel le jour même (nouveau rôle « auteur »), listant qui assure l'aller et le retour et à quelle heure ; Courses et les autres catégories affichaient déjà les précisions nécessaires (liste d'articles / description), sans changement requis — même fonctionnement porté côté avectoi-site (PR #11-12) — voir §3.8
...
- **Rappel d'échéance du jour étendu au Transport + rôle « auteur »** *(NOUVEAU depuis v1.41, PR #468-469)* : le popup de rappel à la connexion (Repas/Affaires/Administratif/Autre depuis v1.35, PR #435 ; Courses depuis la même PR, voir plus haut) s'étend à la catégorie Transport, pour la personne ayant pris en charge (« conductrice ») un trajet aller et/ou retour dont la date confirmée tombe le jour même — bouton « ✓ C'est fait » ouvrant la sheet PIN habituelle. Le contenu du popup s'enrichit aussi de précisions contextuelles : pour la conductrice, bénéficiaire du trajet, heure de la/des jambe(s) prise(s) en charge, et mention de l'autre jambe si elle est aussi prévue mais assurée par quelqu'un d'autre ; pour l'auteur du besoin (ou son bénéficiaire nommé via « Pour une autre personne »), qui ne conduit pas — nouveau rôle « auteur », jamais cumulé avec « conductrice » sur un même besoin — la liste de qui assure l'aller/le retour et à quelle heure, ou « pas encore pris en charge », avec un bouton principal renvoyant vers le besoin dans le mur sans tenter d'ouvrir la sheet PIN. Même fonctionnement porté côté avectoi-site (PR #11-12)
