...
- `app/(admin)/settings.tsx` — toggle d'activation, section "🩺 Planning des intervenants", modales de config (`IntervenantPriorityModal`/`NightIntervenantModal`/`NewsIntervenantModal`), coloration chronologie.
